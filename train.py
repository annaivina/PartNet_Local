...
#opens and deals with provided files 
...
#Saving the model for the exchange -not really nessesary
def onnx(args):
    """
...
def iotest(args, data_loader):
    ...
    if monitor_info:
        monitor_output_path = 'monitor_info.parquet'
        try:
...
def main():
    ...
    if args.local_rank is not None:
        ...
        if args.local_rank != 0:
            stdout = None
    _configLogger('partnet', stdout=stdout, filename=args.log)
